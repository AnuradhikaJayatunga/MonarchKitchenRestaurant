            ...
            <div class="col-lg-8">
                <div class="card m-b-20">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <a class="btn btn-danger btn-sm float-right float-right" href="inactiveAccount">
                                    Inactive
                                    Account</a>
                            </div>
                        </div>
                        ...
                        <form class="" method="post" enctype="multipart/form-data"
                            action="{{ route('updateProfile') }}" id="saveUserId">
                            {{ csrf_field() }}
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fName" autocomplete="off"
                                            name="fName" placeholder="First Name" value="{{ $user->first_name }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lName" autocomplete="off"
                                            name="lName" placeholder="Last Name" value="{{ $user->last_name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="contactNo" autocomplete="off"
                                    name="contactNo" placeholder="+(94) XX XXX XXXX" value="{{ $user->contact_no }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" autocomplete="off"
                                    name="username" placeholder="Email Address" value="{{ $user->user_name }}">
                            ...
                            <button class="btn btn-warning w-md waves-effect waves-light" type="submit">Update
                                User</button>
                        </form>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.errors != null) {
                    ...
                    if (data.errors.role) {
                        var p = document.getElementById('roleError');
                        p.innerHTML = data.errors.role[0];
                    }
